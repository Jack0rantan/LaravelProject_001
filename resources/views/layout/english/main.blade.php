    ...
    <div id="relative z1">
      ...
      <div class="row">
        <div class="col-12" style="background:white;">
          ...
          <div class="row">
            <div class="col-12">
               <h1 style="font-size:5vmin;" class="font-Sawarabi">英語学習 まとめ</h1>
            </div>
          </div>
          ...
          <div class="row">
                ...
                <div class="card mb-3" style="max-width: 54em;">
                  <div class="row no-gutters">
                    ...
                    <div class="col-md-8" style="background:#eeeeee">
                      <div class="card-body">
                        <a href="/english/english-movie-site" style="text-decoration:none; color:black;">
                          <h5 class="card-title" style="background:white;padding:20px">【厳選5選！】おすすめ英語動画サイト【独学応援】</h5>
                        </a>
                        <p class="card-text">TEDなどのオススメの英語動画サイトを紹介いたします。</p>
                        <p class="card-text"><small class="text-muted">2019/04/26</small></p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row no-gutters">
                    <div class="col-md-4">
                      <a href="/english/TED-001">
                        <img src="/img/English/TED-img2.jpg" class="card-img" alt="TED-img">
                      </a>
                    </div>
                    <div class="col-md-8" style="background:#eeeeee">
                      <div class="card-body">
              ...
              <div class="col-12">
                <div class="card mb-3" style="max-width: 54em;">
                  <div class="row no-gutters">
                    <div class="col-md-4">
                      <a href="/english/TED-004">
                        <img src="/img/English/TED-img2.jpg" class="card-img" alt="TED-img">
                      </a>
                    </div>
                    <div class="col-md-8" style="background:#eeeeee">
                      <div class="card-body">
                      <a href="/english/TED-004" style="text-decoration:none; color:black;">
                        <h5 class="card-title" style="background:white; padding:20px"></h5>
                      </a>
                        <p class="card-text"></p>
                        <p class="card-text"><small class="text-muted">2019/05/04</small></p>
                      </div>
                    </div>
                  </div>
                </div>
